 ...
 * 		No initial capacity is required.
 * 		Insert and delete operations are not performance wise expensive.
 * 
 * 		Retrieving element from linked list is slower that array list.
 * 
 * 		Memory consumption is higher that array list as linked list stores element and pointer 
 * 		to it's neighbor.
 * 
 */
