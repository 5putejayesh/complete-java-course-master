...
/*
 * Inheritance:-
 * 		Allows you to define a new class from an existing one and inherits it's attributes 
 * 		and methods.
 * 		Used to avoid code duplication and maintain relationship between classes.
 * 		We use inheritance to maintain IS-A relationship.
 * 		
 */
